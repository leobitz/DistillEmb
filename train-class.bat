...
@REM     python .\train-class.py --accelerator "gpu" --exp-name tig-sent-emb-04 --max_epochs 20 --batch-size 128 --hidden-dim 128 --fc-dropout 0.4 --rnn-dropout 0.4 --emb-dropout 0.4 --embedding-dim 300 --dataset-folder dataset/tig --charset-path data/am-charset.txt --max-seq-len 100 --num-rnn-layers 1 --learning-rate 0.001 --vector-file dataset/corpus/tig/tig-ft.vec --emb-type "emb" --trail-id %%t
@REM )
