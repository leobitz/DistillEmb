...
python .\train-class.py --accelerator "gpu" --exp-name tig-sent-distill-25-256 --max_epochs 60 --batch-size 64 --hidden-dim 256 --fc-dropout 0.2 --rnn-dropout 0.2 --emb-dropout 0.1 --embedding-dim 300 --dataset-folder dataset/tig --charset-path "data/am-charset.txt" --max-seq-len 100 --num-rnn-layers 1 --learning-rate 0.001 --vector-file logs/tig-distill-full32/version_0/checkpoints/epoch=63-step=316288.ckpt --emb-type "CNN" --trial-id %%t --train-model --data-size .33 --step-gamma .9

python .\train-class.py --accelerator "gpu" --exp-name tig-sent-distill-25-256 --max_epochs 60 --batch-size 64 --hidden-dim 256 --fc-dropout 0.2 --rnn-dropout 0.2 --emb-dropout 0.1 --embedding-dim 300 --dataset-folder dataset/tig --charset-path "data/am-charset.txt" --max-seq-len 100 --num-rnn-layers 1 --learning-rate 0.001 --vector-file logs/tig-distill-full32/version_0/checkpoints/epoch=63-step=316288.ckpt --emb-type "CNN" --trial-id %%t --train-model --data-size 1. --step-gamma .9
