...
# m = DistillEmb(list(range(400)), 300, )
...
def create_am_distill_emb(charset_path, dropout=0.0, model_size='large'):
    char2int, _ = lib.build_charset(charset_path, 0)
    model = DistillEmb(char2int,  output_size=300, pad_char=' ', dropout=dropout, model_size=model_size)
    return model
